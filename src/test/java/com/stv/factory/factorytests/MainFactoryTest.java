...
public class MainFactoryTest extends BasicFactoryTest {
    ...
    @Test(description = "Assert the main page is loaded " +
                        "and main logl is visible")
    ...
    @Test(description = "Test error message when Username " +
                        "is empty and Password is entered")
